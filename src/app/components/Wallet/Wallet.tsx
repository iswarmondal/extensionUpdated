...
export default function Wallet (props: IWalletProps) {
  ...
  const truncatedAddress = `${walletAddress.substring(0, 5)}...${walletAddress.substring(walletAddress.length - 4)}`;
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <img src="./matic-token.png" alt="MATIC token" className="h-16 w-16 flex items-center mx-28	 mb-4" />
